...
export const metadata: Metadata = {
  title: "Terms & Conditions | MeriGadi",
  description: "MeriGadi terms and conditions",
};
      ...
      <article className="mx-auto max-w-2xl px-6 py-14">
        ...
        <div className="mt-10 space-y-6 text-sm leading-relaxed text-slate-700">
          <section>
            ...
            <p>
              By accessing or using MeriGadi&apos;s website and services, you agree to these
              Terms &amp; Conditions. If you do not agree, do not use the service. This is a
              starter document and should be reviewed by legal counsel before production use.
            </p>
          </section>
          <section>
            <h2 className="mb-2 text-lg font-semibold text-slate-900">2. Use of the service</h2>
            <p>
              You agree to provide accurate information, keep credentials confidential, and use the
              service only for lawful purposes. You must not attempt to disrupt, misuse, or
          ...
          <section>
            ...
            <p>
              ...
              unauthorized use using the contact method you publish for your business.
            </p>
          </section>
          <section>
            <h2 className="mb-2 text-lg font-semibold text-slate-900">
          ...
          <section>
            <h2 className="mb-2 text-lg font-semibold text-slate-900">5. Changes</h2>
            <p>
          ...
          <section>
            ...
            <p>
              For questions about these terms, contact MeriGadi using the support channel you
